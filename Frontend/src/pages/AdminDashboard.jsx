...
import {
    TbUsers, TbCode, TbMenu2, TbPlus, TbWorld,
    TbSearch, TbBoxOff
} from 'react-icons/tb'
import {
...
function AdminDashboard() {
    ...
    const [activeView, setActiveView] = useState('dashboard')  // ✅ lifted up from SideBarContent
        ...
        <div className="min-h-screen bg-[#030b0d] text-white flex overflow-hidden"
            ...
            <aside className='hidden md:flex flex-col w-60 min-h-screen bg-[#040e11] border-r
             border-white/[0.06] fixed top-0 left-0 z-20'>
                {/* ✅ pass activeView + setActiveView + no setSidebarOpen needed on desktop */}
                <SideBarContent
                ...
                {sidebarOpen && (
                    <>
                        ...
                        <motion.aside
                            ...
                            {/* ✅ fixed typo SidebarContent → SideBarContent, pass setSidebarOpen */}
                            <SideBarContent
                                activeView={activeView}
                                setActiveView={setActiveView}
                    ...
                    <div className='flex items-center gap-3 min-w-0'>
                        <button
                            ...
                            className='md:hidden bg-transparent border-none cursor-pointer p-1.5 rounded-lg
                             text-white/50 hover:text-white/80 hover:bg-white/[0.05] transition-all flex-shrink-0'>
                            <TbMenu2 size={20} />
                        </button>
                        ...
                        <motion.div
                            ...
                            <motion.div
                                ...
                                <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-3
                                 px-4 sm:px-5 py-4 border-b border-white/[0.05]'>
                                        ...
                                        {filteredPublicComponents.map((c, i) => (
                                            <motion.div key={i}
                                                className='flex items-start sm:items-center justify-between gap-3
                                                 px-4 sm:px-5 py-3.5 hover:bg-white/[0.02] transition-colors'>
